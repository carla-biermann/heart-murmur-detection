...
def mae_train_multiple_data(
    ...
    for dt, max_len in data_source.items():
        ...
        train_data = AudioDataset(
            train, augment=True, from_npy=True, max_len=max_len, method=training_method
        )
        val_data = AudioDataset(
            test, augment=True, from_npy=True, max_len=max_len, method=training_method
        )
