...
def process_label(modality="exhalation"):
    ...
    df_user = pd.read_csv(
        data_dir + "participant_metadata.csv", index_col="participant_identifier"
    )
...
def extract_and_save_embeddings(
    feature="operaCE", modality="exhalation", input_sec=8, dim=1280
):
...
if __name__ == "__main__":
    ...
    if args.pretrain in ["vggish", "opensmile", "clap", "audiomae"]:
        ...
        extract_and_save_embeddings(
            args.pretrain, args.modality, input_sec, dim=args.dim
        )
